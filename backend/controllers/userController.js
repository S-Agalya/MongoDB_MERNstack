...
const bookAppointment = async (req, res) => {
    try {
        ...
        const appointmentData = {
            ...
            userData,
            docData,
            amount: docData.fees,  // Ensure docData.fees is correctly set
            slotTime,
            slotDate,
            date: Date.now(),
            cancelled: false,      // Setting a default value if needed
            payment: docData.fees, // Set the payment amount here
            isCompleted: false     // Set a default value for isCompleted
        };
