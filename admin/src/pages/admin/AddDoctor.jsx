...
//      <form className='m-5 text-lg font-medium'>
...
const AddDoctor = () => {
  ...
  const onSubmitHandler = async (event) => {
    ...
    try {
      ...
      formData.append(
        "address",
        JSON.stringify({ line1: address1, lin2: address2 })
      );
  ...
  return (
    <form onSubmit={onSubmitHandler} className="m-5 w-full">
      ...
      <div className="bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll">
          ...
          <div className="w-full lg:flex-1 flex flex-col gap-4">
            <div className="flex-1 flex flex-col gap-1">
              ...
              >
                ...
                <option value="pediatricians">pediatricians</option>
                <option value="Neurologist">Neurologist</option>
                <option value="Gastroentrerologist">Gastroentrerologist</option>
              </select>
            </div>
            <div className="flex-1 flex flex-col gap-1">
              <p>Education</p>
        ...
        <button
          type="submit"
          className="bg-primary mt-4 px-10 py-3 text-white rounded-full"
        >
          Add doctor
        </button>
      </div>
